...
def main():
	...
	parser.add_argument("--adaptive_expansion", action='store_true', default=False, help="Enable adaptive neuron expansion for SAC")
	parser.add_argument("--adaptive_actor_threshold", default=0.2, type=float, help="FAU threshold that triggers actor expansion")
	parser.add_argument("--adaptive_critic_threshold", default=0.3, type=float, help="FAU threshold that triggers critic expansion")
	parser.add_argument("--adaptive_check_interval", default=5000, type=int, help="Training steps between adaptive expansion checks")
	parser.add_argument("--adaptive_expansion_size", default=8, type=int, help="Number of neurons to add per hidden layer when expanding")
